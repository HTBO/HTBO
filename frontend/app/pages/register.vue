...
<template>
    <div class="flex items-center justify-center min-h-screen">
        <div class="w-full max-w-md p-8 space-y-5 bg-slate-700 rounded-xl shadow-2xl shadow-slate-900">
            ...
            <form @submit.prevent="signUp" class="space-y-5">
                <div class="space-y-3">
                    <div class="border border-slate-500 bg-slate-600 rounded-md focus-within:border-slate-300 duration-300">
                        ...
                        <input v-model="username" id="username" name="username" type="text" autocomplete="username" required class="w-full p-3 outline-none rounded-md focus:z-10 sm:text-sm" placeholder="Felhasználónév">
                    </div>
                    <div class="border border-slate-500 bg-slate-600 rounded-md focus-within:border-slate-300 duration-300">
            ...
            <div>
                <p class="text-sm text-center">Van már fiókod? <NuxtLink to="/login"><span class="text-primary-500">Jelentkezz be</span></NuxtLink></p>
            </div>
